        ...
        {//헤더란 공통된 속성 
         ...
         //거래 명세 데이터 조회
            ...
            try
            {
                ...
                rtnDtTemp = HP.FillTable("04WM_TradingManager_S3", CommandType.StoredProcedure
                                                            , HP.CreateParameter("PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                            , HP.CreateParameter("TRADINGNO", sTradingNo, DbType.String, ParameterDirection.Input)
                                                            );
                ...
                ReportViewer rpv = new ReportViewer(reportbook);
                rpv.ShowDialog();
